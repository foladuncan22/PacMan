...
var Interval = setInterval(Run, 200, pos, pageWidth);

// This function determines the direction of PacMan based on screen edge detection. 
function checkPageBounds(direction, pos, pageWidth) {
  // TODO: Complete this to reverse direction upon hitting screen edge
  //check if position equals widest page width divided by image width
  //if so change direction
  //if direction is 0 change to 1, if 1 change to 0
